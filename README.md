...
Here you can find scripts organized into steps (1, 2, and 3) for simulating phylogenetic trees, generating DNA alignments using IQ-TREE, and simulating trait evolution for each tree. 
